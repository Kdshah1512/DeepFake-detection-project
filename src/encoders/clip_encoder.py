...
class CLIPEncoder(nn.Module):
    def __init__(self, model_name="openai/clip-vit-large-patch14"):
        ...
        try:
            self._preprocess = CLIPProcessor.from_pretrained(model_name, use_fast=False)
        except Exception:
            self._preprocess = CLIPProcessor.from_pretrained("openai/clip-vit-base-patch16", use_fast=False)
